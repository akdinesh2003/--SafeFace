...
class WorkingMaskDetector:
    def __init__(self):
        ...
        # Initialize camera with index 2 (which was found to be working)
        ...
        print("Working Face Mask Detection Started!")
        print("Camera opened successfully at index 2!")
    ...
    def add_info_panel(self, frame, face_count, mask_count, status="Running"):
        ...
        cv2.putText(frame, "Working Face Mask Detection", (20, 35), 
    ...
    def run_detection(self):
        """Main detection loop"""
        print("Starting Working Face Mask Detection...")
        print("Using camera index 2 (working camera)")
        ...
        while True:
            ...
            # Display frame
            cv2.imshow('Working Face Mask Detection', frame)
