...
class DemoMaskDetector:
    def __init__(self):
        ...
        self.face_history = []  # Store recent face detections
    ...
    def add_info_panel(self, frame, face_count, mask_count):
        ...
        cv2.putText(frame, "Face Mask Detection Demo", (20, 35), 
    ...
    def run_demo(self):
        """Main demo loop"""
        print("Starting Face Mask Detection Demo...")
        print("This demo uses simple color and texture analysis")
        ...
        while True:
            ...
            # Display frame
            cv2.imshow('Face Mask Detection Demo', frame)
